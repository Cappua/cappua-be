...
march_competition = Competition.create(
  ...
  rules: 'Verse submissions are due by March 14th. Final vote tally and winner announcement on April 1st. Rappers can edit the track, but most stay within 16 bars.',
...
feb_competition = Competition.create(
  ...
  genre: 'East Coast Hip Hop',
  rules: 'Verse submissions are due by February 14th. Final vote tally and winner announcement on March 1st. Rappers can edit the track, but most stay within 16 bars.',
